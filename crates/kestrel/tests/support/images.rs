...
//! the consuming job pulls what its sibling built rather than building a second one. A variable
//! that is unset, which is every local run, leaves the test building the image for itself.
